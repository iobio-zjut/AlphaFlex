...
parser.add_argument("--af2_dir", default="./alphafold-2.2.0", help="AlphaFold code and weights directory")
parser.add_argument("--output_dir", default="./af-output", help="Where to write output files")
...
def make_model_runner(name, recycles):
  ...
  params = data.get_model_haiku_params(name, args.af2_dir)  # <-- 尝试这样修改
  print('read params')
...
write_results(result, os.path.join(args.output_dir, name + '.pdb'))
